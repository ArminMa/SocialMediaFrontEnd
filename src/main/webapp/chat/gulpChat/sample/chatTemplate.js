angular.module("irontec.simpleChat").run(["$templateCache",
    function($templateCache)
    {$templateCache.put("chatTemplate.html","<div ng-show=\"visible\" class=\"row chat-window col-xs-5 col-md-3 {{vm.theme}}\" " +
